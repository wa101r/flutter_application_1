          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  children: [
                    Text("Firstname: Thanaphat", style: TextStyle(fontWeight: FontWeight.bold)),
                    Spacer(), 
                    Text("Lastname: Riangsoong", style: TextStyle(fontWeight: FontWeight.bold)),
                    Spacer(),
                    Text("Nickname: Bote", style: TextStyle(fontWeight: FontWeight.bold)),
                  ],
                ),
                SizedBox(height: 10),
